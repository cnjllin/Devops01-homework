...
class Server(db.Model):
    ...
    idc_id              = db.Column(db.Integer, nullable=True, index=True, default=0)
    ...
    os_type             = db.Column(db.String(30), index=True, nullable=True, default='')
    os_version          = db.Column(db.String(30), index=True, nullable=True, default='')
    ...
    last_op_people      = db.Column(db.Integer, nullable=False, default=0)
...
class ZbHost(db.Model):
    ...
    zb_hostid           = db.Column(db.Integer, index=True, unique=True)
