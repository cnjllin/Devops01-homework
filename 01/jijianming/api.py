...
class AutoLoad(object):
	...
	self.method = None
	self.__methodlist = ['get','update','create','delete']
	self.get_metod = self.__methodlist
    ...
    def isValidMethod(self, func=None):
        ...
        """
	self.mothod = func
	return hasattr(self.get_metod,self.mothod)
    ...
    def getCallMethod(self):
        """
            返回可执行的方法
        """
	if self.method in dir(self.module_name) #判断这个模块有这个方法，
		return self.method
	else:
		return none
    ...
    def _load_module(self):
        ...
        """
	ret = False
	for filename in (os.path.listdir(self.moduledir)):
