...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:123456@127.0.0.1/51reboot'
app.config['SQLALCHEMY_COMMIT_ON_TEARDOWN'] = True  #在每次请求结束后自动提交数据库改变
...
class Servertype(db.Model):
    ...
    manufacturers_id    = db.Column(db.Integer, db.ForeignKey("manufacturers.id"))
...
class Server(db.Model):
    ...
    manufacturers       = db.Column(db.String(50), db.ForeignKey('manufacturers.id'))
    manufacture_date    = db.Column(db.Date)
    server_type         = db.Column(db.String(20))
    st                  = db.Column(db.String(60))
    ...
    inner_ip            = db.Column(db.String(32))
